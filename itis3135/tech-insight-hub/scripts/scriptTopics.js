...
document.querySelectorAll(".topic-btn").forEach((button) => {
  button.addEventListener("click", () => {
    ...
    const contentWeb = '<section><h2>💻 Web Development & UX</h2><p>Web development is evolving with AI-driven personalization, modern frameworks, and responsive design.</p></section>';
    const contentCyber = '<section><h2>🔐 Cybersecurity & Data Protection</h2><p>AI-powered security systems are detecting threats and preventing cyberattacks in real time.</p></section>';
